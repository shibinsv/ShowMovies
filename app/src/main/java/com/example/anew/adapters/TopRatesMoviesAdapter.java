...
import com.example.anew.fragments.TopRatedMoviesFragment;
...
public class TopRatesMoviesAdapter extends RecyclerView.Adapter<TopRatesMoviesAdapter.ViewHolder>{
    ...
    public TopRatesMoviesAdapter(Context context, TopRatedMoviesFragment mtopRatedMoviesFragment, ArrayList<DataList> list) {
        this.context = context;
        this.mtopRatedMoviesFragment = mtopRatedMoviesFragment;
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_top_rates_movies_adapter, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.rootMovies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mtopRatedMoviesFragment.getMovieByID(sID);
            }
        });
    }
